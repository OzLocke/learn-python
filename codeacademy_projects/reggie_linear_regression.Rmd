---
title: "Reggie Linear Regression"
author: "Oz Locke"
date: "09/01/2020"
...
```
    ...
    <ipython-input-3-82106fee0c4b> in <module>()
...
Hint (to view this hint, either double-click this cell or highlight the following white space):
...
```
      ...
      Expected: 0.30000000000000004 1.7000000000000002 4.999999999999999
